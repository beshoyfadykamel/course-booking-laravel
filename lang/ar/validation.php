...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | رسائل مخصصة لنماذج الطلبات
    |--------------------------------------------------------------------------
    */

    // رسائل التحقق من الحجوزات
    'student_id.required' => 'حقل الطالب مطلوب.',
    'student_id.exists' => 'الطالب المختار غير صحيح.',
    'student_id.duplicate_enrollment' => 'هذا الطالب مسجل بالفعل في هذه الدورة.',
    'student_id.duplicate_enrollment_trash' => 'هذا الطالب مسجل بالفعل في هذه الدورة (حتى في سلة المهملات). قم باستعادته بدلاً من ذلك.',
    'course_id.required' => 'حقل الدورة مطلوب.',
    'course_id.exists' => 'الدورة المختارة غير صحيحة.',
    'status.required' => 'حقل الحالة مطلوب.',
    'status.in' => 'يجب أن تكون الحالة نشطة أو غير نشطة.',

    // رسائل التحقق من الدورات
    'title.required' => 'عنوان الدورة مطلوب.',
    'title.string' => 'يجب أن يكون عنوان الدورة نصاً.',
    'title.max' => 'قد لا يتجاوز عنوان الدورة 255 حرفاً.',
    'title.min' => 'يجب أن يكون عنوان الدورة 3 أحرف على الأقل.',
    'title.unique' => 'عنوان الدورة موجود بالفعل.',
    'description.required' => 'وصف الدورة مطلوب.',
    'description.string' => 'يجب أن يكون وصف الدورة نصاً.',
    'description.max' => 'قد لا يتجاوز وصف الدورة 1000 حرف.',
    'description.min' => 'يجب أن يكون وصف الدورة 10 أحرف على الأقل.',

    // رسائل التحقق من الطلاب
    'name.required' => 'حقل الاسم مطلوب.',
    'email.required' => 'حقل البريد الإلكتروني مطلوب.',
    'email.email' => 'يجب أن يكون البريد الإلكتروني عنوان بريد إلكتروني صحيح.',
    'email.unique' => 'البريد الإلكتروني مستخدم بالفعل.',
    'email.unique.student' => 'هذا البريد الإلكتروني مستخدم بالفعل من قبل طالب آخر.',
    'country_id.required' => 'حقل الدولة مطلوب.',
    'country_id.exists' => 'الدولة المختارة غير صحيحة.',
    'image.image' => 'يجب أن يكون الملف صورة.',
    'image.mimes' => 'يجب أن تكون الصورة من نوع: jpg, jpeg, png, webp, gif.',
    'image.max' => 'يجب ألا يتجاوز حجم الصورة 2 ميجابايت.',

    // رسائل التحقق من المستخدمين
    'password.required' => 'حقل كلمة المرور مطلوب.',
    'password.confirmed' => 'تأكيد كلمة المرور غير متطابق.',
    'role.required' => 'حقل الدور مطلوب.',
    'role.in' => 'يجب أن يكون الدور مدير أو مستخدم.',
