...
@section('content')
    <div x-data="bookingForm()">
        ...
        <div x-show="showStudentModal" x-transition
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full h-auto m-4 z-10">
                ...
                <div class="px-6 py-4 max-h-96 overflow-y-auto space-y-3">
                    ...
                    <div class="space-y-2 text-sm">
                        ...
                        <div class="flex justify-between"><span
                                class="font-medium text-gray-600">{{ __('messages.email') }}:</span><span
                                id="studentEmail">-</span></div>
                        <div class="flex justify-between"><span
                                class="font-medium text-gray-600">{{ __('messages.country') }}:</span><span
