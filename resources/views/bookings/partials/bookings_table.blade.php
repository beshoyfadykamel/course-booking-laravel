    ...
    <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-3 text-sm">
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('bookings.edit', $booking->id) }}" class="inline-flex items-center px-2.5 py-1 bg-yellow-600 text-white rounded hover:bg-yellow-700 transition text-xs"><i class="fas fa-pencil-alt me-1"></i> {{ __('messages.edit') }}</a>
